...
export default function CreateLisiting() {
  ...
  const [imgThumnail, setImgThumbnail] = useState<string | undefined>(
    undefined
  );
      ...
      <div className={style.content}>
        ...
        >
          <div className={style.fileContainer}>
            ...
            <input
              required
              onChange={(e) => showImageThumbnail(e)}
              accept="image/*"
              id="file-upload"
              type="file"
            />
          ...
          <div className={style.nameContainer}>
            ...
            <input
              required
              type="text"
              placeholder="For example, MacBook Air 2018"
              id="listingform-name"
            />
          </div>
          <div className={style.infoContainer}>
            <div>
              ...
              <select id="listingform-category">
                {categories
